...
export function SearchInput({ className = "", onClear, value, ...props }: SearchInputProps) {
  return (
    <div className="relative">
      <svg
        className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 dark:text-slate-500"
      ...
      <input
        type="text"
        className={`
          w-full pl-10 pr-9 py-2.5 text-sm bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg
